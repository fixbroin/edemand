...
const AllProviders = () => {
  ...
  const [isFetchingNewFilter, setIsFetchingNewFilter] = useState(false);
  ...
  const shouldShowSkeleton = hasLocation && ((isLoading && currentProviders === 0) || (isFetchingNewFilter && isPlaceholderData));
  const isLoadingMore = hasLocation && isFetching && isPlaceholderData && !isFetchingNewFilter && currentProviders > 0;
          ...
          <div className="container mx-auto py-6">
            {shouldShowSkeleton ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                {isLoadingMore &&
                  Array.from({ length: Math.min(limitStep, totalProviders - currentProviders) }).map((_, index) => (
