...
const BookingDetails = () => {
  ...
  // Actually cancel the booking after user picks reason
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 gap-6">
            <main className="w-full space-y-6">
              ...
              {bookingData?.status === "cancelled" &&
                (bookingData?.cancel_reason || bookingData?.cancel_additional_info) && (
                  <>
                    <Separator />
                    <section className="space-y-3" aria-labelledby="cancel-reason-heading">
                      <h2 id="cancel-reason-heading" className="description_color">
                          ...
                          {bookingData?.cancel_reason && (
                            <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                              ...
                              <span className="text-base font-medium break-words">
                                {bookingData?.translated_cancel_reason ||
                                  bookingData?.cancel_reason}
                              </span>
                            </div>
                          )}
                          {bookingData?.cancel_additional_info && (
